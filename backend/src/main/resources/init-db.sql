-- ============================================
-- ORGANİK TARIM - INIT DATABASE (Tek Dosya)
-- Schema + Data (Tablolar + Örnek Veriler)
-- ============================================
-- Bu dosyayı H2 Console veya veritabanı aracınızda çalıştırın
-- ============================================

-- ============================================
-- 1. TABLOLARI SIFIRLA (Eğer varsa temizle)
-- ============================================
-- Önce foreign key içeren tabloları sil (sıralı - bağımlı olanlar önce)
...
-- ============================================
-- 3. ÖRNEK VERİLER (Data)
-- ============================================

-- Kullanıcılar (Şifreler: "123456" - BCrypt hash)
