-- ============================================
-- ORGANİK TARIM - COMPLETE DATABASE (Schema + Data)
-- Tek dosya: Tablolar + Örnek Veriler
-- ============================================
...
-- ============================================
-- 2. ÖRNEK VERİLER (Data)
-- ============================================

-- Kullanıcılar (Şifreler: plain text "123456" için BCrypt hash)
...
(1, 1, 1, 3, 15.00, 45.00),    -- 3 kg domates
(2, 1, 4, 2, 20.00, 40.00),    -- 2 kg elma
(3, 1, 7, 1, 12.00, 12.00),    -- 1 litre süt
(4, 2, 2, 2, 12.00, 24.00),    -- 2 kg salatalık
(5, 2, 5, 1, 25.00, 25.00),    -- 1 kg portakal
(6, 3, 9, 2, 45.00, 90.00),    -- 2 kg peynir
(7, 3, 10, 1, 35.00, 35.00),   -- 1 paket yumurta
(8, 4, 3, 2, 18.00, 36.00),    -- 2 kg biber
(9, 4, 6, 1, 30.00, 30.00),    -- 1 kg muz
(10, 5, 4, 5, 20.00, 100.00),  -- 5 kg elma
(11, 5, 5, 3, 25.00, 75.00),   -- 3 kg portakal
(12, 6, 8, 2, 15.00, 30.00),   -- 2 kg yoğurt
(13, 6, 1, 2, 15.00, 30.00),   -- 2 kg domates
(14, 7, 9, 3, 45.00, 135.00),  -- 3 kg peynir
(15, 7, 2, 1, 12.00, 12.00),   -- 1 kg salatalık
(16, 8, 5, 4, 25.00, 100.00),  -- 4 kg portakal
(17, 8, 10, 1, 35.00, 35.00),   -- 1 paket yumurta
(18, 9, 7, 3, 12.00, 36.00),   -- 3 litre süt
(19, 9, 3, 1, 18.00, 18.00),   -- 1 kg biber
(20, 10, 9, 4, 45.00, 180.00); -- 4 kg peynir

-- Finansal Raporlar (Son 30 gün)
...
(1, 6, 4, '2024-02-15 10:00:00'),  -- Fatma -> Elma
(2, 6, 7, '2024-02-20 11:00:00'),  -- Fatma -> Süt
(3, 7, 1, '2024-02-25 09:00:00'),  -- Ahmet -> Domates
(4, 8, 9, '2024-03-01 14:00:00');  -- Zeynep -> Peynir
...
(5, 10, 4, 5, 4, 'Elmalar güzeldi ama bazıları vardı.', TRUE, '2024-03-15 14:00:00');
