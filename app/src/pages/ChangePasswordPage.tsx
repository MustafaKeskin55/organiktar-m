    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="mx-auto w-12 h-12 md:w-16 md:h-16 bg-yellow-100 rounded-full flex items-center justify-center mb-3 md:mb-4">
            <AlertCircle className="h-6 w-6 md:h-8 md:w-8 text-yellow-600" />
          </div>
          <CardTitle className="text-xl md:text-2xl">Şifre Değiştirme Zorunlu</CardTitle>
        </CardHeader>
