-- ============================================
-- ORGANIK TARIM - COMPLETE DATABASE SCHEMA
-- Tarih: 2026-04-02
-- Aciklama: TUM tablolar - %100 dinamik
-- ============================================

SET FOREIGN_KEY_CHECKS = 0;

DROP TABLE IF EXISTS order_items, orders, product_images, products, addresses, categories, site_content, financial_reports, payment_settings, site_settings, users;
DROP VIEW IF EXISTS producer_orders_view, daily_sales_summary;
...
-- ============================================
-- 3. SITE CONTENT (DINAMIK ICERIKLER)
-- ============================================
...
('hero_stats', 'HERO', '{"stats": [{"icon": "Leaf", "value": "0", "label": "Yerel Uretici", "dynamic": true, "source": "producer_count"}, {"icon": "Star", "value": "0", "label": "Mutlu Musteri", "dynamic": true, "source": "consumer_count"}, {"icon": "Truck", "value": "0", "label": "Teslimat", "dynamic": true, "source": "order_count"}], "floating_badge": {"text": "Yakinlarinizdaki", "value": "0", "suffix": "+ Uretici", "dynamic": true, "source": "producer_count"}}', 1);

-- Nasil Calisir Adimlari
INSERT INTO site_content (content_key, content_type, content_data, display_order) VALUES
('how_it_works', 'STEPS', '{"steps": [{"icon": "Search", "title": "Kesfet", "description": "Yakinlarinizdaki ureticileri ve taze urunleri kesfedin.", "color": "bg-blue-100 text-blue-600"}, {"icon": "ShoppingCart", "title": "Siparis Ver", "description": "Sevdiginiz urunleri sepete ekleyin, tek tikla siparis verin.", "color": "bg-green-100 text-green-600"}, {"icon": "Truck", "title": "Kapiniza Gelsin", "description": "Taze urunler ureticiden dogrudan kapiniza teslim edilsin.", "color": "bg-orange-100 text-orange-600"}, {"icon": "Sprout", "title": "Destek Olun", "description": "Yerel ureticileri destekleyin, surdurulebilir tarimi tesvik edin.", "color": "bg-purple-100 text-purple-600"}]}', 2);

-- Musteri Yorumlari
INSERT INTO site_content (content_key, content_type, content_data, display_order) VALUES
('testimonials', 'TESTIMONIALS', '{"testimonials": [{"name": "Merve K.", "location": "Kadikoy, Istanbul", "image": "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100", "rating": 5, "text": "Artik pazara gitmeye gerek kalmadi. Taze sebzelerim haftalik olarak kapima geliyor.", "role": "Abone"}, {"name": "Can Y.", "location": "Besiktas, Istanbul", "image": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100", "rating": 5, "text": "Zeytinyagi siparisi ettim, gercekten soguk sikim ve dogal. Tadi marketlerdekilerden cok farkli.", "role": "Musteri"}, {"name": "Elif T.", "location": "Uskudar, Istanbul", "image": "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100", "rating": 5, "text": "Cocuklarim icin guvenilir gida bulmak cok onemli. Organik urunlere uygun fiyata ulasiyorum.", "role": "Anne"}]}', 3);

-- Abonelik Planlari
INSERT INTO site_content (content_key, content_type, content_data, display_order) VALUES
('subscription_plans', 'PLANS', '{"plans": [{"name": "Mini Sepet", "price": 149, "period": "haftalik", "description": "Bekarlar ve ciftler icin ideal", "features": ["4-5 kg mevsim sebze & meyve", "2-3 cesit urun", "Ucretsiz teslimat", "Iptal edilebilir"], "popular": false}, {"name": "Aile Sepeti", "price": 299, "period": "haftalik", "description": "3-4 kisilik aileler icin", "features": ["8-10 kg mevsim sebze & meyve", "5-6 cesit urun", "Ucretsiz teslimat", "Oncelikli musteri destegi", "Iptal edilebilir"], "popular": true}, {"name": "Organik Sepet", "price": 449, "period": "haftalik", "description": "Tamamen organik urunler", "features": ["8-10 kg organik sebze & meyve", "Sertifikali organik urunler", "Ucretsiz teslimat", "Oncelikli musteri destegi", "Iptal edilebilir"], "popular": false}]}', 4);

-- ChatBot
INSERT INTO site_content (content_key, content_type, content_data, display_order) VALUES
('chatbot_responses', 'CHATBOT', '{"welcome_message": "Merhaba! Organik Tarim'a hos geldiniz. Size nasil yardimci olabilirim?", "quick_questions": ["Kargo ucreti ne kadar?", "Siparisim nerede?", "Iade politikasi nedir?", "Urunler organik mi?"], "responses": {"kargo": "Kargo ucretimiz 29.99 TL'dir. 250 TL uzeri siparislerde kargo ucretsizdir.", "siparis": "Siparisinizi 'Siparislerim' sayfasindan takip edebilirsiniz.", "iade": "Iade politikamiz: Teslimattan itibaren 14 gun icinde iade yapabilirsiniz.", "organik": "Evet, tum urunlerimiz organik ve yerel ureticilerden gelmektedir."}}', 5);
...
-- SONUC
-- ============================================
SELECT 'Database OK - All tables created' as status;
