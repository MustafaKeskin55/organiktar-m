...
-- Tarih: 2026-04-02
-- Aciklama: Tüm tablolar ve ilişkiler (Güvenli versiyon)
-- ============================================

-- ============================================
-- 0. ONCELIKLE TUM TABLOLARI SIL (TEMIZ BASLANGIC)
-- ============================================
...
SELECT CONCAT('Total Tables: ', COUNT(*)) as table_count FROM information_schema.tables WHERE table_schema = DATABASE();
SELECT CONCAT('Total Users: ', COUNT(*)) as user_count FROM users;
SELECT CONCAT('Total Products: ', COUNT(*)) as product_count FROM products;
SELECT CONCAT('Total Orders: ', COUNT(*)) as order_count FROM orders;
